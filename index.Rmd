...
lm(S1~P1+E2,data=frag23_sub) # calculates the linear model with P1 AND E2 as features and S1 as output
model <- lm(S1 ~ P1 + E2, data = frag23_sub) # recalculates linear model and assigns a refrence to it
